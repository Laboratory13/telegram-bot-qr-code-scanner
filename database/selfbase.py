...
class User:
    def __init__(self, id, full_name, lang, is_admin, tel = "0", status = 0, msg_id = 0, chat_id = 0, seller_id = 0):
        self.id = id
...
def insert_user(full_name, tg_id, phone, seller_id, is_admin=0, lang="ru"):
